...
<p>
<img width="551" height="99" id="_x0000_i1025"
...
an object with 
<span style="font-style: italic;">--debug</span> to see these
tracebacks. &nbsp;Note that COM objects used by server processes (such as
ASP) generally have no valid stdout, so will still need to use 
<span
