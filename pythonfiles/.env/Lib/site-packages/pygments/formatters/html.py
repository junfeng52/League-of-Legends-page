...
<span>`` tags. By default, the content is enclosed
    ...
    .. sourcecode:: html
        ...
        <table><tr>
          ...
          <td class="code">
            <pre>
<span class="Ke">def </span>
<span class="NaFu">foo</span>(bar):
...
<span>`` tags (as well as line number elements)
    ...
    `debug_token_types`
        Add ``title`` attributes to all token ``
<span>`` tags that show the
        name of the token.
